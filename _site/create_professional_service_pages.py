# create_professional_service_pages.py
import os

# Professional service page template with the exact hover effect
...
<meta http-equiv="Content-Security-Policy" content="upgrade-insecure-requests">
    ...
    <style>
        ...
        .service-card-main:hover .detail-box {{
            background: rgba(255, 255, 255, 0.1) !important;
            backdrop-filter: blur(10px);
        }}
        
        .service-card-main:hover .benefits-box {{
            background: rgba(255, 255, 255, 0.15) !important;
        }}
        
        .service-card-main:hover .cta-button {{
    ...
    <section class="services" style="padding: 80px 20px;">
        <div class="container" style="max-width: 1200px; margin: 0 auto;">
            <div class="service-detail-content">
                <h2 class="section-title" style="text-align: left; margin-bottom: 30px; color: var(--navy);">Professional {title}</h2>
                
                <!-- Main Service Card with Hover Effect -->
                <div class="service-card-main">
                    <div class="service-content" style="padding: 3rem;">
                        <h3 class="service-title" style="font-size: 2rem; margin-bottom: 1.5rem; text-align: center; border-bottom: 3px solid var(--teal); padding-bottom: 1rem;">Service Overview</h3>
                        <p class="service-description" style="font-size: 1.2rem; line-height: 1.7; text-align: center; margin-bottom: 2rem;">
                            {description}
                        </p>
                        
                        <div class="detail-box" style="background: #f8fafc; padding: 2rem; border-radius: 10px; margin: 2rem 0;">
                        ...
                        <div class="benefits-box service-features" style="margin: 2rem 0;">
                        ...
                        <div class="service-cta" style="margin-top: 2rem; text-align: center;">
                            <a href="tel:+14054106402" class="cta-button" style="display: inline-block; margin: 0 10px; padding: 12px 25px; font-size: 1.1rem; transition: all 0.3s ease;">Call Now: (405) 410-6402</a>
                            <a href="/contact" class="cta-button" style="display: inline-block; margin: 0 10px; padding: 12px 25px; font-size: 1.1rem; background: var(--navy); transition: all 0.3s ease;">Get Free Estimate</a>
                        </div>
                    </div>
                </div>
...
# Create professional service pages with hover effects
for slug, service in service_data.items():
    ...
    # Create the page
    html_content = professional_template.format(
        title=service["title"],
    ...
    print(f"Created professional: {page_path}")

print("Created service pages with the exact gradient hover effect!")