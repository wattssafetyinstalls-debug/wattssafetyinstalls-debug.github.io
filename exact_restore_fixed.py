#!/usr/bin/env python3
"""
EXACT Template Restoration - Uses your complete 800+ line template exactly as provided
No emojis, no changes, just replaces the placeholders
"""

import os

# Your EXACT template - I'll use the one you provided
...
def get_service_info(filename):
    ...
    # SEO descriptions for each service
    descriptions = {
        ...
        'ada-compliant-showers': 'ADA compliant shower installations and bathroom modifications in Norfolk NE. Create accessible, safe bathrooms with zero-step entries, commercial-grade grab bars, and slip-resistant flooring.',
        'tv-mounting': 'Professional TV mounting services in Norfolk NE. Secure wall mounting, optimal viewing angles, and cable management for residential and commercial installations.',
        ...
        'deck-construction': 'Custom deck construction and repair services in Norfolk NE. Build durable, beautiful decks with proper safety railings.',
        'audio-visual': 'Professional audio visual installation services in Norfolk NE. Home theater systems, whole-home audio, and smart home integration.',
        'grab-bars': 'Commercial-grade grab bars and safety rail installations in Norfolk NE. 500+ lb rated grab bars for maximum safety.',
        'non-slip-flooring': 'Non-slip flooring installations for enhanced safety throughout your home or business in Norfolk NE.',
        'custom-ramps': 'Custom-built accessibility ramps designed to meet ADA requirements in Norfolk NE.',
        'senior-safety': 'Comprehensive senior safety modifications for aging in place in Norfolk NE.',
        'concrete-pouring': 'Professional concrete pouring and installation services in Norfolk NE.',
        'driveway-installation': 'Complete driveway installation and replacement services in Norfolk NE.',
        'hardwood-flooring': 'Hardwood flooring installation and refinishing services in Norfolk NE.',
        'landscape-design': 'Professional landscape design and installation services in Norfolk NE.',
        'garden-maintenance': 'Expert garden maintenance and care services in Norfolk NE.',
        'painting-services': 'Professional interior and exterior painting services in Norfolk NE.',
        'fence-installation': 'Custom fence installation and repair services in Norfolk NE.',
        'window-doors': 'Window and door installation services in Norfolk NE.',
        'gutter-cleaning': 'Professional gutter cleaning and maintenance services in Norfolk NE.',
        'pressure-washing': 'Expert pressure washing services in Norfolk NE.',
    }
...
def restore_exact_template():
    """Restore the EXACT template to all service pages"""
    ...
    for filename in os.listdir(services_dir):
        if filename.endswith('.html') and not filename.endswith('.backup'):
            ...
            # Replace placeholders in the exact template
    ...
    print(f"SUCCESS: Restored exact template to {updated_count} service pages")
    print("All CSS, tracking, and visual design preserved exactly as provided")
