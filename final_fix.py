#!/usr/bin/env python3
"""
FINAL FIX - Complete template with all CSS intact
"""

import os

# COMPLETE TEMPLATE WITH ALL CSS
...
# SPECIFIC PROFESSIONAL DESCRIPTIONS
PRO_DESCRIPTIONS = {
    "tv-mounting.html": """Professional TV mounting services in Norfolk, NE and surrounding areas. Watts Safety Installs provides reliable television wall mounting with proper viewing angles, cable management, and secure installations. I serve Norfolk, Madison, Stanton, Pierce, and nearby communities with flexible scheduling.
...
Safety and quality workmanship are my priorities. As a licensed Nebraska contractor, I ensure every installation meets proper safety standards. Call (405) 410-6402 today to discuss your TV mounting needs.""",

    "snow-removal.html": """Reliable snow removal services in Norfolk, Nebraska and surrounding areas. Watts Safety Installs provides driveway clearing, sidewalk shoveling, and basic ice management for residential properties throughout Northeast Nebraska.

When winter weather hits, I am ready to help keep your property accessible and safe. Using dependable equipment and proper techniques, I focus on clearing driveways, walkways, and steps to prevent slips and falls. I use pet-safe ice melt and pay attention to details like mailbox access.
...
Call (405) 410-6402 to discuss your snow clearing needs.""",
...
Whether you are updating one room or need flooring throughout your home, I provide honest assessments and clear pricing. I take the time to explain your options and help you choose flooring that will work well in Nebraska s climate conditions.
...
Call (405) 410-6402 today to discuss your flooring project.""",

    "fertilization.html": """Professional lawn fertilization and weed control services in Norfolk, Nebraska. Watts Safety Installs provides comprehensive lawn care solutions including seasonal fertilization, weed prevention, and turf health management for residential properties.

Our fertilization programs are tailored to Nebraska s specific soil conditions and grass types. We use quality fertilizers that provide consistent nutrient delivery without burning your lawn. Each application includes weed control to prevent dandelions, crabgrass, and other common Nebraska weeds.

We offer seasonal programs that address your lawn s changing needs throughout the year - spring treatments, summer stress protection, fall root-building applications, and winterizer preparations. Our approach ensures even coverage and maximum effectiveness.

Voice search optimized: "Find lawn fertilization services near me in Norfolk Nebraska" - Watts Safety Installs delivers professional results for your lawn.

Call (405) 410-6402 today for your free lawn analysis."""
}
...
def fix_all_pages():
    ...
    for filename in os.listdir(services_dir):
        ...
        if filename in PRO_DESCRIPTIONS:
            description = PRO_DESCRIPTIONS[filename]
        else:
            description = f"""Professional {service_name} services in Norfolk, Nebraska. Watts Safety Installs provides expert {service_name.lower()} solutions for homeowners throughout Northeast Nebraska.

Our professional approach ensures quality workmanship using proper techniques and materials. We focus on customer satisfaction and reliable service that stands the test of time. Every project receives our comprehensive attention from initial consultation to final cleanup.

Voice search optimized: "Find {service_name.lower()} services near me in Norfolk Nebraska" - Watts Safety Installs delivers professional results you can trust.

Call (405) 410-6402 today for your free consultation."""
        
        final_html = COMPLETE_TEMPLATE.replace("__SERVICENAME__", service_name)
    ...
    print(f"COMPLETE - {fixed_count} pages fixed with complete templates and professional descriptions")
