#!/usr/bin/env python3
"""
Restore the full professional template to all service pages
"""

import os
import shutil

# Your FULL professional template (from your original service template)
...
<body>
    ...
    <section class="hero">
        ...
        <p>Professional {service_name} in Norfolk NE</p>
...
def get_service_info(filename):
    ...
    descriptions = {
        'accessibility-safety-solutions': 'Professional accessibility and safety solutions in Norfolk NE. We specialize in ADA compliance, grab bar installations, wheelchair ramps, and senior safety modifications to create secure, accessible environments for individuals with mobility challenges.',
        'ada-compliant-showers': 'ADA compliant shower installations and bathroom modifications in Norfolk NE. Create accessible, safe bathrooms with zero-step entries, commercial-grade grab bars, and slip-resistant flooring. ATP Approved Contractor.',
        'tv-mounting': 'Professional TV mounting services in Norfolk NE. Secure wall mounting, optimal viewing angles, and expert cable management for residential and commercial installations. Same-day service available.',
        'snow-removal': 'Reliable snow removal and de-icing services in Norfolk NE. Emergency snow removal available with 15% OFF first 3 visits in 2025. Licensed and insured for commercial and residential properties.',
        'lawn-maintenance': 'Comprehensive lawn maintenance and care services in Norfolk NE. Regular mowing, fertilization, weed control with LAWN2026 20% OFF season special. Professional landscaping services available.',
        'kitchen-renovations': 'Professional kitchen renovations and remodeling in Norfolk NE. Transform your kitchen with custom cabinets, countertops, modern appliances, and accessible design features for aging in place.',
        'bathroom-remodels': 'Complete bathroom remodeling services in Norfolk NE. Create beautiful, functional bathrooms with accessibility features, modern designs, and safety modifications for seniors and individuals with mobility challenges.',
        'home-remodeling': 'Full-service home remodeling and renovation in Norfolk NE. From room additions to complete home transformations, we handle projects of all sizes with precision and quality craftsmanship.',
        'deck-construction': 'Custom deck construction and repair services in Norfolk NE. Build durable, beautiful decks with proper safety railings and accessibility features for outdoor living enjoyment.',
        'audio-visual': 'Professional audio visual installation services in Norfolk NE. Home theater systems, whole-home audio, smart home integration, and commercial AV solutions with expert setup and calibration.',
    }
    ...
    # Generic description
    generic_desc = f'Professional {base_name} services in Norfolk NE. ATP Approved Contractor serving all of Nebraska with licensed, insured, and same-day service availability. Nebraska License #54690-25. Call (405) 410-6402 for free estimate.'
    
    return base_name, generic_desc

def restore_professional_template():
    """Restore the full professional template to all service pages"""
    ...
    for filename in os.listdir(services_dir):
        if filename.endswith('.html') and not filename.endswith('.backup'):
            ...
            # Generate new content with FULL template
            new_content = FULL_TEMPLATE.format(
            ...
            updated_count += 1
            print(f"Restored professional template: {filename}")
    
    print(f"Successfully restored professional template to {updated_count} service pages!")

if __name__ == "__main__":
    restore_professional_template()