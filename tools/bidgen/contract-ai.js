...
(function() {
  ...
  var SYS = [
    ...
    'When you draft or generate a contract, ALWAYS include a ```contract-json block at the END of your response.',
    'CRITICAL: The "contractBody" field must contain the FULL, COMPLETE contract text you drafted above — every section, every clause, every word — as a single string with \\n for line breaks.',
    'The system will render this contractBody directly into the final PDF-ready document. If contractBody is missing or short, the user only gets a skeleton. Do NOT summarize it. Copy the entire contract verbatim into contractBody.',
    '```',
    '{"contractType":"service","clientName":"...","clientContact":"...","clientTitle":"...","clientEmail":"...","clientPhone":"...","clientAddress":"...","contractNum":"WSI-CTR-001","projectName":"...","jobCity":"Norfolk, NE","startDate":"YYYY-MM-DD","endDate":"YYYY-MM-DD","renewalTerms":"month-to-month","pricingType":"hourly","priceHourly":65,"priceMinHours":2,"priceTotal":0,"priceDeposit":0,"priceMonthly":0,"priceVisits":0,"priceSeasonTotal":0,"priceSeasonMonths":7,"scopeItems":["...","..."],"paymentTerms":"net30","lateFee":"1.5pct","cancellationPolicy":"30day","materialsPolicy":"contractor","customTerms":"...","termsSections":[{"title":"Payment Terms","subs":[{"text":"Net 30 days from invoice date."},{"text":"A late fee of 1.5% per month applies to overdue balances."}]},{"title":"Termination","subs":[{"text":"Either party may terminate with 30 days written notice."},{"text":"Client shall pay for all work completed prior to termination date."}]},{"title":"Warranty","subs":[{"text":"All labor warranted for 1 year from completion date."}]}],"contractBody":"FULL CONTRACT TEXT HERE — copy every section you wrote above verbatim"}',
    '```',
    '',
    '## AMENDMENT DRAFTING',
